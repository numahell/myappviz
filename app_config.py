...
PROJECT_SLUG = 'myappviz3'

# Project name to be used in file paths
PROJECT_FILENAME = 'myappviz3'

# The name of the repository containing the source
REPOSITORY_NAME = 'myappviz3'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1rLWFl5_AniMWI5GIY1bFDYTugqFnO3ztYAfSeKBEqew'
